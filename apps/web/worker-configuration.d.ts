/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0046f3ee4bb837bcd5727c145f9f07a0)
// Runtime types generated with workerd@1.20260831.1 2026-08-22 enable_request_signal,nodejs_compat,request_signal_passthrough
interface __BaseEnv_Env {
	HYPERDRIVE: Hyperdrive;
	ORIGIN_URL: "https://retire-plan-lvs5yigt4a-uc.a.run.app";
	FIREBASE_PROJECT_ID: "gen-lang-client-0372385774";
	RUST_SERVICE_URL: "https://rust-simulation-service-lvs5yigt4a-uc.a.run.app";
	ORIGIN_SECRET: string;
	SIGNUP_INVITE_CODES: string;
	GCP_SA_CLIENT_EMAIL: string;
	GCP_SA_PRIVATE_KEY: string;
	GCP_SA_PRIVATE_KEY_ID: string;
	QUOTA: DurableObjectNamespace<import("./src/worker/index").QuotaCounter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "QuotaCounter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ORIGIN_URL" | "FIREBASE_PROJECT_ID" | "RUST_SERVICE_URL" | "ORIGIN_SECRET" | "SIGNUP_INVITE_CODES" | "GCP_SA_CLIENT_EMAIL" | "GCP_SA_PRIVATE_KEY" | "GCP_SA_PRIVATE_KEY_ID">> {}
}
