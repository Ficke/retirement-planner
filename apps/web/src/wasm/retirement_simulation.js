/* @ts-self-types="./retirement_simulation.d.ts" */
 ...
 * @returns {any}
 */
export function run_simulation(request) {
    const ret = wasm.run_simulation(request);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function run_sweep_shard(request) {
    const ret = wasm.run_sweep_shard(request);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./retirement_simulation_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('retirement_simulation_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
